...
import CreateQuiz from '../user/dashboard/Quiz/CreateQuiz';
import Quiz from '../user/dashboard/Quiz/Quiz';

function HomeDashboardTest() {
...
export default HomeDashboardTest